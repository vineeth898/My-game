...
display(){
    ...
    switch(this.acount){
        case 1: text(a1.cost,950,200);text(a1.aero,960,230);image(this.tp1,910,145,110,35);image(this.tp1,150,580,550,175);if(this.t!=null){image(this.t,230,665,100,100);image(this.t,560,670,100,100);}if(a1.state==='not owned'){this.pay1.show();this.equip1.hide();this.pay1.mousePressed(()=>{this.pay1.hide();money=money-a1.cost;a1.state='owned';});}if(a1.state==='owned'){this.equip1.position(1086,140);this.equip1.show();}this.ac=a1.cost;break;
        case 2: text(a2.cost,950,200);text(a2.aero,960,230);image(this.tp2,910,145,110,30);image(this.tp2,150,580,600,150);if(this.t!=null){image(this.t,220,645,100,100);image(this.t,580,650,100,100);}if(a2.state==='not owned'){this.pay1.show();this.equip1.hide();this.pay1.mousePressed(()=>{this.pay1.hide();money=money-a2.cost;a2.state='owned';});}if(a2.state==='owned'){this.equip1.position(1086,140);this.equip1.show();}this.ac=a2.cost;break;
        case 3: text(a3.cost,950,200);text(a3.aero,960,230);image(this.tp3,910,145,110,25);image(this.tp3,150,580,550,125);if(this.t!=null){image(this.t,230,635,80,80);  image(this.t,545,640,80,80);}  if(a3.state==='not owned'){this.pay1.show();this.equip1.hide();this.pay1.mousePressed(()=>{this.pay1.hide();money=money-a3.cost;a3.state='owned';});}if(a3.state==='owned'){this.equip1.position(1086,140);this.equip1.show();}this.ac=a3.cost;break;
    }
